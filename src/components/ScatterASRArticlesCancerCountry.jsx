...
const ScatterASRArticlesCancerCountry = ({ csvPath }) => {
  ...
  // Responsive square plot + dynamic factor
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%" }}>
      <Plot
        ...
        layout={{
          title: { text: `Cancer research vs incidence in <b>${selectedCountry}</b>`, y: 0.98, x: 0.5, xanchor: "center", font: { size: 18, color: "black" }, automargin: true },
          ...
          margin: { t: 60 * sizeFactor, b: 60, l: 80, r: 40 }, // top margin scales with sizeFactor
